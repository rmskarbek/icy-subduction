...
%%% Schematic plot of the model geometry with the slab, ice shell and coordinate 
%%% axes.
...
%%% Plots of the temperature, viscosity, and porosity fields within the slab only.
...
ForcesPlot1(Bend, Buoyancy, Shear, Out);