...
%%% Initiation of Subduction. The calculation consists of computing the force required
%%% to initiate motion on an existing fault plane with a given dip angle. This serves 
%%% as an estimate of the minimum force necessary to promote trench formation, 
%%% because other resisting forces (e.g. plate bending) are ignored.
...
%%% in Mueller & Phillips for a 100 My old slab.
    if i == i_30
        figure;
...
%%% Plot the resistance against the dip angle to reproduce Fig. 3 in Mueller & 
%%% Phillips for a 100 My old slab.
figure
